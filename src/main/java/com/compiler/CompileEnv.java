...
public class CompileEnv implements CompileEnvIntf {
    ...
    private StmtParser m_parser;
    com.compiler.ast.ASTStmtNode m_root;
    ...
    public CompileEnv(String input, boolean trace) throws Exception {
        ...
        m_lexer = new Lexer();
        m_lexer.init(input);
        m_parser = new StmtParser(m_lexer, m_symbolTable, m_functionTable);
    ...
    public void compile() throws Exception {
        ...
        m_root = m_parser.parseBlockStmt();
        m_root.codegen(this);
    }
